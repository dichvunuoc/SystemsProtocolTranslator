...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="BS or fuzzy match on beads-sync" workflow="{project-root}/_bmad/bmm/workflows/beads-integration/workflow.yaml">[BS] Beads Sync: Sync BMAD artifacts to Beads for enhanced context tracking and recovery.</item>
    <item cmd="BC or fuzzy match on beads-context">[BC] Beads Context: Recover working context from Beads after compact or new session.</item>
